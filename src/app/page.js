                ...
                >
                  ...
                  >
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-200/90 font-medium tracking-wide px-4">
                      Innovative Solutions. Seamless Services. Trusted Partnerships.
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="mt-4">
                      <p className="text-sm sm:text-base text-slate-300/80 font-light">
                        Established in <span className="font-semibold text-blue-300">2017</span>
                      </p>
                    </div>
                  </motion.div>
                </motion.div>
