    ...
    <Card3D className="h-full">
      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm opacity-90">Erandavane, Pune</p>
            </div>
            <motion.div
              className="text-2xl"
        ...
        >
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3783.433010266135!2d73.8289066757366!3d18.50932458258205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa01c08293752e9c7%3A0x198c381e0bd1c067!2sYanik%20Associates!5e0!3m2!1sen!2sin!4v1754476998724!5m2!1sen!2sin"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-semibold text-gray-800">Office No. 9, 2nd Floor, Prasad Apartment, Near Nal Stop Metro Station, Erandavane, Pune, Maharashtra 411004</p>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open('https://maps.app.goo.gl/XMxmUWDTVu5siTwF9', '_blank')}
            >
...
const QuickContactForm = ({ isInView }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/919975953293?text=${encodeURIComponent(message)}`;
  ...
  const contactMethods = [
    {
      icon: "💬",
      title: "WhatsApp",
      value: "+91 99759 53293",
      action: () => window.open('https://wa.me/919975953293', '_blank'),
    ...
    },
    {
      icon: "📱",
      title: "Phone Call",
      value: "+91 84591 53562",
      action: () => window.open('tel:+918459153562'),
    ...
    },
    {
      icon: "✉️",
      title: "Email",
      value: "admin@yanikassociates.com",
      action: () => window.open('mailto:admin@yanikassociates.com'),
