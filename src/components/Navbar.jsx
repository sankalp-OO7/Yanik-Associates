...
// --- Per-letter gradient logo (fallback) ---
const logoText = "Yanik Associates";
...
// --- Component ---
function NavbarComponent({ logoImageSrc }) { // Added logoImageSrc as a prop
        ...
        <div className="mx-auto flex items-center justify-between px-4 sm:px-8 py-4 max-w-7xl relative z-10 w-full">
          {logoImageSrc ? (
            <Image 
              ...
              className="max-h-12 w-auto animate-pulse"
            />
          ) : (
    ...
    <>
      ...
      >
        <div className="mx-auto flex items-center justify-between px-4 sm:px-8 py-4 max-w-7xl relative z-10 h-20 sm:h-24">
          {/* LOGO: Conditional rendering for image or text */}
          <motion.button
          ...
          >
            {logoImageSrc ? (
              <Image 
                ...
                width={200} // Adjust width as needed
                height={50} // Adjust height as needed
                className="max-h-16 w-auto drop-shadow-lg"
              ...
              <motion.span
                ...
                className="inline-block text-2xl sm:text-3xl font-extrabold tracking-wide bg-gradient-to-r from-purple-600 via-blue-500 to-cyan-500 text-transparent bg-clip-text drop-shadow-lg"
